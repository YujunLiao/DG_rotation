...
from trainer_utils.training_argument.DGJigsawTrainingArgument import DGJigsawTrainingArgument
from trainer_utils.data_loader.DGJigsawDataLoader import DGRotationDataLoader
...
def lazy_train(my_training_arguments, output_manager):
    ...
    DG_jigsaw_data_loader = DGRotationDataLoader(my_training_arguments, is_patch_based_or_not)
    ...
    trainer = DGRotationTrainer(my_training_arguments, my_model, DG_jigsaw_data_loader, my_optimizer, my_scheduler, device, output_manager)
    trainer.do_training()
...
if __name__ == "__main__":
    ...
    my_training_arguments = DGJigsawTrainingArgument()
