...
class ResNet(nn.Module):
    def __init__(self, block, layers, jigsaw_classes=1000, classes=100, domains=3):
        ...
        self.rotation_classifier = nn.Linear(512 * block.expansion, jigsaw_classes) # here jigsaw_classes actually is rotation classes
        self.jigsaw_classifier = nn.Linear(512 * block.expansion, 31)
