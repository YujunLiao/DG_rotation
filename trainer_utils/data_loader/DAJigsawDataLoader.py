...
from trainer_utils.data_loader.DA_jigsaw_dataset.DAJigsawDataset import DAJigsawDataset


class DAJigsawDataLoader:
    ...
    def _get_train_and_validation_and_test_data_loader(self, my_training_arguments, is_patch_based_or_not=False):
        ...
        DA_jigsaw_dataset = DAJigsawDataset(my_training_arguments, is_patch_based_or_not)
        source_domain_train_dataset=DA_jigsaw_dataset.source_domain_train_dataset
        target_domain_train_dataset=DA_jigsaw_dataset.target_domain_train_dataset
        validation_dataset=DA_jigsaw_dataset.validation_dataset
        test_dataset=DA_jigsaw_dataset.test_dataset
