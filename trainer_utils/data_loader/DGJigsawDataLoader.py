...
from trainer_utils.data_loader.DG_jigsaw_dataset.DGJigsawDataset import DGJigsawDataset
...
class DGRotationDataLoader:
    ...
    def _get_train_and_validation_and_test_data_loader(self, my_training_arguments, is_patch_based_or_not=False):
        ...
        jigsaw_dataset = DGJigsawDataset(my_training_arguments, is_patch_based_or_not)
        train_dataset=jigsaw_dataset.train_dataset
        validation_dataset=jigsaw_dataset.validation_dataset
        test_dataset=jigsaw_dataset.test_dataset
