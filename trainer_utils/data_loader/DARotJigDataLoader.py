...
from trainer_utils.data_loader.DA_rot_jig_dataset.DARotationDataset import DARotationDataset
...
class DARotationDataLoader:
    ...
    def __init__(self, my_training_arguments, is_patch_based_or_not):
        ...
        """
        self.source_domain_train_data_loader, self.target_domain_train_data_loader, self.validation_data_loader, self.test_data_loader, self.test_rotation_data_loader = \
    ...
    def _get_train_and_validation_and_test_data_loader(self, my_training_arguments, is_patch_based_or_not=False):
        ...
        test_rotation_dataset = DA_rotation_dataset.test_rotation_dataset
        ...
        return source_domain_train_data_loader, target_domain_train_data_loader, validation_data_loader, test_data_loader, test_rotation_data_loader
