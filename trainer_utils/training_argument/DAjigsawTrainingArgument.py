...
class DAJigsawTrainingArgument(argparse.ArgumentParser):
    ...
    """
    def __init__(self):
        super(DAJigsawTrainingArgument, self).__init__(
    ...
    def _get_arguments_from_console(self):
        ...
        self.add_argument("--number_of_unsupervised_classes", type=int, default=31, help="Number of classes for the jigsaw task")
